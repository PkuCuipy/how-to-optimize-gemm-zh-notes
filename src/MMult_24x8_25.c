...
void PackMatrixA(int k, double* a, int lda, double* a_to) {
    ...
    for (j = 0; j < k; j++) {
        ...
        _mm512_storeu_pd(a_to + 0, _mm512_loadu_pd( a_ij_ptr + 0));
        _mm512_storeu_pd(a_to + 8, _mm512_loadu_pd( a_ij_ptr + 8));
        _mm512_storeu_pd(a_to + 16, _mm512_loadu_pd( a_ij_ptr + 16));
        a_to += 24;
    }
}
