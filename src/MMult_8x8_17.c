...
void AddDot8x8(int k, double* a, double* b, double* c, int ldc) {
    ...
    _mm512_store_pd(C_incr + 8, c01__c71_vreg);
    _mm512_store_pd(C_incr + 16, c02__c72_vreg);
    _mm512_store_pd(C_incr + 24, c03__c73_vreg);
    _mm512_store_pd(C_incr + 32, c04__c74_vreg);
    _mm512_store_pd(C_incr + 40, c05__c75_vreg);
    _mm512_store_pd(C_incr + 48, c06__c76_vreg);
    _mm512_store_pd(C_incr + 56, c07__c77_vreg);
